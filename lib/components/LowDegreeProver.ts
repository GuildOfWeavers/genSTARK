...
import { FiniteField, Vector, Matrix, AirObject } from '@guildofweavers/air-script';
...
export class LowDegreeProver {
    ...
    // CONSTRUCTORS
    // --------------------------------------------------------------------------------------------
    constructor(idxGenerator: QueryIndexGenerator, hash: Hash, context: AirObject, logger: LogFunction) {
